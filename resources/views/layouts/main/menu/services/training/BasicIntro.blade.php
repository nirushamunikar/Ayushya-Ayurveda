...
@section('title')
    Basic Concept of Ayurveda | Ayushya Ayurvedav
@endsection
               ...
               <div id="exTab3" class="container">
                  ...
                  <div class="tab-content clearfix">
                     <div class="tab-pane active" id="1a">
                        ...
                        <ol>
                           <li>Celestial and historical period, chronology of Ayurveda according to different schools,
                              modern period
                           </li>
                           <li>Eight branches and eighteen branches of Ayurveda</li>
                           <li>Brihatrayi and Laghutrayi</li>
                           <li>Chronological development of Charaka Samhita, Sushruta Samhita and Kashyapa Samhita</li>
                           <li>Nepal and Ayurveda: Kashyapa Samhita, Saushruta Nighantu, Chandra Nighantu, Nepal
                              Nighantu; Singha Durbar VaidyaKhana; Festival-Culture and Ayurveda; Jiva Narayana taila,
                              Mimiya, Jesthavasadi Churna, Kasturadi Goli, Rohitaka and Laligurans, Lapsi
                           </li>
                        </ol>
                        ...
                        <ol>
                           ...
                           <li>Tridosha: general introduction, properties and functions; classification, locations,
                              specific properties and functions
                           </li>
                           <li>Dhatu and upadhatu: Rasa, Rakta, Mamsa, Meda, Asthi, Majja, Sukra and their formation,
                              guna, karma and pramana; Stanya and Aartava, Tvaka
                           </li>
                           <li>Mala and dhatu mala: Aahara mala: Purisha, Mutra, Sweda and their properties and
                              functions; Dhatu mala: samkhya and pramana
                           </li>
                           <li>Deha Prakriti</li>
                        ...
                        <ol>
                           <li>Dincharya (daily schedule), Ratricharya (night schedule), Ritucharya (seasonal
                              schedule)
                           </li>
                        ...
                        V. Disease
                        <ol>
                           <li>Etiological factor (Ahara, vihara; Kala, Indriyartha samyoga and Pragyaparadha; Bhuta and
                              Dosha)
                           </li>
                           <li>Pancha nidana</li>
                           ...
                           <li>Principle of treatment: Samsamana, Samshodhana, Nidanaparivarjana; Daivavyapashraya,
                              Yuktivyapashraya, Shastrapranidhana; Upakrama (dwividha and shadvidha); Pathya-apathya
                           </li>
                        </ol>
                     </div>
                     <div class="tab-pane" id="2a">
                        <ol>
                           ...
                           <li>Clinical Anatomy in Ayurveda : Prof. D.G. Thatte and Prof Suresh Chandra</li>
